...
<div id="create">
	<label style="text-align: left; margin-left: 2%;" >Create</label>
	<br>
	<center>
	<button><a href="assignment.php" style="text-decoration: none; float: center; font-size: 30px; color: white;">Assignment</button></a>
	<br>
	<button><a href="exam.php" style="text-decoration: none; font-size: 30px; color: white;">Exam</button></a>
	</center>
